...
.dashboard__loading, .dashboard__error { padding: 12px; color: #555; }

.cards { display: flex; flex-direction: column; gap: 16px; margin-bottom: 16px; }
.cards__group {}
.cards__title { margin: 0 0 8px; font-size: 16px; color: #333; }
.cards__row { display: flex; gap: 12px; }
.cards__row--wrap { flex-wrap: wrap; }
.cards__empty { color: #777; padding: 8px 0; }

.card { border: 1px solid #eee; border-radius: 8px; padding: 12px; min-width: 120px; background: #fafafa; }
.card__label { font-size: 12px; color: #555; margin-bottom: 4px; }
.card__value { font-size: 24px; font-weight: 700; }

.card--status-open { border-color: #c7d2fe; background: #eef2ff; }
.card--status-pending { border-color: #fde68a; background: #fef3c7; }
.card--status-closed { border-color: #bbf7d0; background: #f0fdf4; }

.card--category-billing { border-color: #fed7aa; background: #fff7ed; }
.card--category-technical { border-color: #a5f3fc; background: #ecfeff; }
.card--category-account { border-color: #bbf7d0; background: #f0fdf4; }
.card--category-sales { border-color: #fbcfe8; background: #fdf2f8; }
.card--category-general { border-color: #c7d2fe; background: #eef2ff; }

.chart {}
.chart__title { margin: 0 0 8px; }
.chart__canvas { width: 100%; max-width: 800px; height: 320px; border: 1px solid #eee; border-radius: 4px; background: #fff; }
</style>
